...
Centros=["ETSI Industriales","ETS Arquitectura","ETS Edificación","ETSI Informáticos","ETSI Aeronáutica y del Espacio","ETSI Agronómica Alimentaria y de Biosistema",
...
for Recurso in Recursos:
    ...
    for Centro in Centros:
        ...
        for ano in anos: 
            ...
            #fin bucles
    nombre_fichero = "Clustering_" + Recurso + ".csv"
    df_data.to_csv(nombre_fichero,index=False)
    df_data = pd.DataFrame(data)
# %%
